...
Though not part of `C# 7.2` or any other language specification, these 2 types were added to the framework as side enhancement of these features. See [Span&lt;T&gt; Struct](https://docs.microsoft.com/en-us/dotnet/api/system.span-1?view=netcore-2.2) and [Memory&lt;T&gt; Struct](https://docs.microsoft.com/en-us/dotnet/api/system.memory-1?view=netcore-2.2) documentation for details.
